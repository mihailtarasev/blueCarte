...
- (void)magasineButtonPaladin {
    PECSettingsViewCtrl *checkin = [self.storyboard instantiateViewControllerWithIdentifier:@"restoranStoryID"];
...
- (void)checkin {
    PECSettingsViewCtrl *checkin = [self.storyboard instantiateViewControllerWithIdentifier:@"checkInStoryID"];
//    checkin.venue = self.selected;
    [self.navigationController pushViewController:checkin animated:YES];
}
...
- (void)getDataAtCardURL:(NSString*) URL PARAMS: (NSString*) PARAMS
{
    ...
    */
    ...
    [net getLocationDataServer:^(id sender){
